    ...
    <div className="w-full px-4 sm:px-8 lg:px-12 xl:px-16" id="client-feedback">
      <section className="py-16 md:py-24 px-6 sm:px-14 lg:px-16 rounded-[2.5rem] bg-[#ffffff] dark:bg-[#101b17] border-2 border-[#f7d7b0] dark:border-[#253630] shadow-2xl transition-all duration-300 relative overflow-hidden">
        ...
        <div
          ...
          className="relative z-10 rounded-3xl bg-[#fefaf5] dark:bg-[#172420] border border-[#f7d7b0] dark:border-[#253630] p-8 sm:p-14 lg:p-16 select-none shadow-md flex flex-col justify-between min-h-[420px] space-y-8"
        >
          {/* Top Control Bar */}
          ...
          <div className="pt-6 border-t border-[#f7d7b0] dark:border-[#253630] flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto flex-1 max-w-md">
              ...
              <div className="relative flex-1 h-2 rounded-full bg-white dark:bg-[#101b17] border border-[#f7d7b0] dark:border-[#253630] overflow-hidden">
                <motion.div
            ...
            <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      activeIndex === idx
                        ...
                        : "bg-white dark:bg-[#101b17] text-[#7A6A5F] dark:text-[#B8ACA0] border-[#f7d7b0] dark:border-[#253630] hover:border-[#f15e1c]"
                    )}
              ...
              <div className="flex items-center gap-2 pl-2 border-l border-[#f7d7b0] dark:border-[#253630]">
                <button
                  type="button"
                  onClick={handlePrev}
                  className="p-2.5 rounded-xl bg-white dark:bg-[#101b17] border border-[#f7d7b0] dark:border-[#253630] text-[#1b2823] dark:text-[#ffffff] hover:bg-[#f15e1c] hover:text-white hover:border-[#f15e1c] transition-all cursor-pointer active:scale-95"
