          ...
          <div className="mt-8 pt-6 border-t border-[#EFE2D6] dark:border-[#2C241E] flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center space-x-2 self-end sm:self-center">
              <button
                type="button"
                onClick={prev}
                className="w-10 h-10 rounded-xl border border-[#EFE2D6] dark:border-[#2C241E] bg-[#FFFDF9] dark:bg-[#1E1915] hover:bg-[#FBF3EA] dark:hover:bg-[#261F1A] hover:border-[#E8672A] dark:hover:border-[#E8672A] flex items-center justify-center text-[#3A2E27] dark:text-[#FAF5EE] transition-colors cursor-pointer shadow-xs"
