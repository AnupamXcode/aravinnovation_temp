...
export function DirectAnswerAEOBlock() {
  return (
    <section
      ...
      className="w-full py-4 sm:py-6 md:py-10 px-4 sm:px-8 lg:px-12 xl:px-16 bg-[#FFFDF9] dark:bg-[#050505] transition-colors duration-300"
    >
      <ScrollReveal direction="up">
        <div className="max-w-6xl mx-auto rounded-2xl sm:rounded-3xl p-4 sm:p-8 md:p-10 bg-gradient-to-br from-[#fefaf5] via-white to-[#fdf6ee] dark:from-[#0a0a0a] dark:via-[#111111] dark:to-[#161616] border-2 border-[#f7d7b0] dark:border-[#222222] shadow-xl space-y-4 sm:space-y-6 relative overflow-hidden">
          {/* Subtle Ambient Glow */}
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3 border-b border-[#f7d7b0]/60 dark:border-[#222222] pb-3 sm:pb-4">
            <div className="flex items-center gap-2 sm:gap-2.5">
              <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg sm:rounded-xl bg-[#f15e1c]/10 text-[#f15e1c] flex items-center justify-center font-bold shrink-0">
                <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              </div>
              <div>
                <span className="text-[9px] sm:text-[10px] font-mono font-bold uppercase tracking-widest text-[#f15e1c]">
                  EXECUTIVE BRIEFING &bull; DIRECT ANSWER
                </span>
                <h2 className="text-base sm:text-xl font-extrabold font-display text-[#1b2823] dark:text-[#ffffff]">
                  What Does Arav Innovations Do?
                </h2>
              </div>
            </div>

            <div className="inline-flex items-center gap-1.5 sm:gap-2 text-[11px] sm:text-xs font-mono font-semibold text-[#2e936f] dark:text-[#74c4ab]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6 items-center">
            <div className="md:col-span-7 space-y-2 sm:space-y-3">
              <p className="text-sm sm:text-lg font-bold text-[#1b2823] dark:text-[#ffffff] leading-relaxed">
              ...
              <p className="text-xs sm:text-base text-[#4a5c55] dark:text-[#d3eee4] font-medium leading-relaxed">
            ...
            <div className="md:col-span-5 p-4 sm:p-5 rounded-xl sm:rounded-2xl bg-white dark:bg-[#141414] border border-[#f7d7b0] dark:border-[#262626] shadow-sm space-y-2.5 sm:space-y-3">
