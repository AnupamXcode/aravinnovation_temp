    ...
    return (
      <div className="w-full space-y-1.5 text-left">
        ...
        <textarea
          ...
          required={required}
          className={cn(
            "w-full rounded-lg border bg-white dark:bg-[#172420] px-3.5 py-2.5 text-sm text-[#1b2823] dark:text-[#ffffff] placeholder:text-[#4a5c55]/60 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#f15e1c] focus:border-transparent disabled:opacity-50 disabled:bg-[#f7d7b0]/20 resize-y",
            error
