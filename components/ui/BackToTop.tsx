    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          onClick={scrollToTop}
          className="fixed bottom-4 left-3 sm:bottom-6 sm:left-6 z-40 p-2.5 sm:p-3 rounded-full bg-[#f15e1c] text-white shadow-xl hover:bg-[#d44e14] focus:outline-none focus:ring-2 focus:ring-[#f15e1c] focus:ring-offset-2 transition-all cursor-pointer group min-h-[44px] min-w-[44px] flex items-center justify-center border border-white/20"
