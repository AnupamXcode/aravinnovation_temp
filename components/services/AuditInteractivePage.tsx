...
// 4 Core Solutions Items for Audit & Improvement
const auditSolutionsData = [
  {
    ...
    route: "/services/audit-and-improvement",
  },
  {
    numStr: "02",
...
const pricingPlans = [
  {
    ...
    description: "Ideal for growing organizations seeking a initial operational workflow audit & bottleneck scan.",
    isPopular: false,
    features: [
      "Operational Workflow Diagnostic Audit",
      "Process Bottleneck & Redundancy Scan",
      "Basic Financial Resource Allocation Check",
      "30-Minute Advisory Review Call",
      "Prioritized Audit Findings Report",
    ],
  ...
  },
  {
    ...
    description: "Complete operational & financial audit, process redesign, compliance verification, and action blueprint.",
    isPopular: true,
    features: [
      "Full Operational & Financial Process Audit",
      "Workflow Redesign & Automation Blueprint",
      "Regulatory Compliance Gap Analysis",
      "Quarterly Performance Benchmarking",
      "Bi-weekly Strategy Advisory Calls",
      "Dedicated Senior Audit Director",
    ],
  ...
  },
  {
    ...
    description: "Continuous performance monitoring pod, real-time telemetry analytics, and dedicated audit team.",
    isPopular: false,
    features: [
      "Enterprise Continuous Audit Execution",
      "Real-Time Telemetry Dashboard Setup",
      "Dedicated Operations & Compliance Pod",
      "Quarterly Executive Board Reporting",
      "Continuous Optimization Feedback Loop",
      "Unlimited Audit Consultations",
    ],
...
export function AuditInteractivePage({ service }: AuditPageProps) {
  ...
  const totalSolutions = auditSolutionsData.length;
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF9] dark:bg-[#12100E] text-[#3A2E27] dark:text-[#FAF5EE] transition-colors duration-300 overflow-x-hidden">
      {/* =========================================================================
          1. HERO — IMMERSIVE DIAGNOSTIC & IMPROVEMENT SYSTEM
          ========================================================================= */}
      <section className="relative min-h-[92vh] flex flex-col justify-between pt-28 pb-12 px-4 sm:px-6 lg:px-12 border-b border-[#f7d7b0]/60 dark:border-[#253630]">
        {/* Subtle Background Analytical Grid & Diagnostic Pathways */}
        <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden opacity-25 dark:opacity-20">
          <svg className="w-full h-full animate-pulse-slow" viewBox="0 0 1200 800" fill="none">
            <defs>
              <linearGradient id="audit-line-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <line x1="200" y1="200" x2="600" y2="400" stroke="url(#audit-line-grad)" strokeWidth="1.5" strokeDasharray="5 5" />
            <line x1="600" y1="400" x2="1000" y2="200" stroke="url(#audit-line-grad)" strokeWidth="1.5" strokeDasharray="5 5" />
            <line x1="600" y1="400" x2="600" y2="700" stroke="url(#audit-line-grad)" strokeWidth="2" />
            <line x1="300" y1="600" x2="600" y2="700" stroke="url(#audit-line-grad)" strokeWidth="1.5" strokeDasharray="4 4" />
            <line x1="900" y1="600" x2="600" y2="700" stroke="url(#audit-line-grad)" strokeWidth="1.5" strokeDasharray="4 4" />

            <circle cx="200" cy="200" r="6" fill="#f15e1c" className="animate-ping-slow" />
            <circle cx="600" cy="400" r="8" fill="#f15e1c" />
            <circle cx="1000" cy="200" r="6" fill="#2e936f" />
            <circle cx="600" cy="700" r="8" fill="#fab60a" />
          </svg>
        ...
        {/* Dominant Headline: Uncover Insights, Drive Excellence */}
        <div className="relative z-10 max-w-5xl mx-auto w-full my-auto text-center space-y-6 pt-6 pb-10">
          ...
          >
            Uncover Insights, <span className="text-[#f15e1c]">Drive Excellence</span>
          </motion.h1>
          ...
          >
            In-depth operational, financial, and compliance audits designed to eliminate friction, optimize workflows, and build systems for continuous performance improvement.
          </motion.p>
        ...
        <div className="relative z-10 text-center pb-2">
          <a href="#our-solutions" className="inline-flex flex-col items-center gap-2 group cursor-pointer">
            <span className="text-xs font-mono font-bold tracking-widest text-[#7A6A5F] dark:text-[#B8ACA0] group-hover:text-[#f15e1c] transition-colors">
              SCROLL TO EXPLORE DIAGNOSTIC SYSTEM
            </span>
      ...
      {/* =========================================================================
          2. OUR SOLUTIONS — CONNECTED PERFORMANCE DIAGNOSTIC SYSTEM
          ========================================================================= */}
        ...
        <div className="max-w-7xl mx-auto space-y-12 select-none">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold font-display tracking-tight text-[#1b2823] dark:text-[#ffffff]">
              Transform your organization through its strengths
            </h2>
            <p className="text-sm sm:text-base text-[#4a5c55] dark:text-[#d3eee4]">
              Drag or click below to explore each audit discipline and its diagnostic framework.
            </p>
          </div>
          ...
          >
            ...
            {/* Dynamic Diagnostic Flow Diagram for Active Solution */}
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 text-center w-full max-w-4xl">
                    {[
                      { label: "OBSERVE", sub: "Raw Workflows" },
                      { label: "AUDIT SCAN", sub: "Evidence Gathering" },
                      { label: "DIAGNOSE", sub: "Bottleneck Analysis" },
                      { label: "OPTIMIZE", sub: "Process Redesign" },
                      { label: "MEASURE", sub: "Continuous Gains" },
                    ].map((node, i) => (
                      <div
                        key={i}
                        className={cn(
          ...
          <div className="p-8 sm:p-14 rounded-[2.5rem] bg-[#fefaf5] dark:bg-[#172420] border-2 border-[#f7d7b0] dark:border-[#253630] shadow-xl space-y-6 relative overflow-hidden">
            ...
            <div className="pt-4 border-t border-[#f7d7b0] dark:border-[#253630] space-y-1">
              ...
              <div className="text-xs font-mono font-bold text-[#2e936f] pt-1">
                Audit &amp; Operational Improvement Partner
              </div>
            </div>
          </div>
        </div>
      ...
      {/* =========================================================================
          4. LARGE EDITORIAL IMPROVEMENT STATEMENT & ABSTRACT ARCHITECTURE VISUAL
          ========================================================================= */}
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <p className="text-base sm:text-lg text-[#4a5c55] dark:text-[#d3eee4] leading-relaxed font-normal">
              Arav Innovations helps organizations uncover inefficiencies, strengthen compliance, optimize processes, and build systems for continuous performance improvement.
            </p>
          </div>

          {/* Right Column: Original Abstract Performance Core Visual */}
            ...
            <div className="relative w-72 h-72 sm:w-80 sm:h-80 rounded-3xl bg-[#fefaf5] dark:bg-[#172420] border-2 border-[#f7d7b0] dark:border-[#253630] shadow-2xl p-6 flex flex-col justify-between items-center text-center overflow-hidden">
              ...
              <div className="relative z-10 flex items-center gap-2 pt-2">
                ...
                <span className="text-xs font-mono font-bold uppercase tracking-wider text-[#1b2823] dark:text-[#ffffff]">
                  ARAV PERFORMANCE CORE
                </span>
              </div>

              {/* Connected Abstract Audit Diagnostic SVG */}
              <svg className="w-48 h-48 relative z-10 my-auto" viewBox="0 0 100 100" fill="none">
                <line x1="20" y1="50" x2="50" y2="20" stroke="#f15e1c" strokeWidth="2" strokeDasharray="3 3" />
                <line x1="50" y1="20" x2="80" y2="50" stroke="#2e936f" strokeWidth="2" strokeDasharray="3 3" />
                <line x1="80" y1="50" x2="50" y2="80" stroke="#fab60a" strokeWidth="2" strokeDasharray="3 3" />
                <line x1="50" y1="80" x2="20" y2="50" stroke="#f15e1c" strokeWidth="2" strokeDasharray="3 3" />
                <circle cx="50" cy="50" r="7" fill="#f15e1c" className="animate-pulse" />
                <circle cx="50" cy="20" r="5" fill="#2e936f" />
                <circle cx="80" cy="50" r="5" fill="#fab60a" />
                <circle cx="50" cy="80" r="5" fill="#2e936f" />
                <circle cx="20" cy="50" r="5" fill="#f15e1c" />
              </svg>
      ...
      {/* =========================================================================
          5. HOW WE WORK — STICKY CONNECTED 4-STAGE AUDIT PIPELINE
          ========================================================================= */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-12 border-b border-[#f7d7b0]/60 dark:border-[#253630]">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            ...
            <p className="text-sm sm:text-base text-[#4a5c55] dark:text-[#d3eee4]">
              A disciplined analytical methodology taking your organization from initial audit discovery to continuous performance tuning.
            </p>
          </div>
          ...
          {/* Continuous Improvement Loop Banner */}
          <div className="p-4 rounded-2xl bg-[#fce3d3] dark:bg-[#261f1a] border border-[#f7d7b0] text-center max-w-2xl mx-auto flex items-center justify-center gap-3">
            ...
            <span className="text-xs font-mono font-bold text-[#f15e1c]">
              CONTINUOUS IMPROVEMENT LOOP: OBSERVE &rarr; AUDIT &rarr; DIAGNOSE &rarr; IMPROVE &rarr; MEASURE &rarr; REFINE
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-12 border-b border-[#f7d7b0]/60 dark:border-[#253630]">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold font-display tracking-tight text-[#1b2823] dark:text-[#ffffff]">
              Transparent Audit Packages
            </h2>
            <p className="text-sm sm:text-base text-[#4a5c55] dark:text-[#d3eee4]">
              Select from fixed-scope operational audits, complete process redesigns, or enterprise telemetry retainers.
            </p>
          </div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-12 border-b border-[#f7d7b0]/60 dark:border-[#253630]">
        <div className="max-w-5xl mx-auto rounded-[2.5rem] bg-[#fefaf5] dark:bg-[#172420] border-2 border-[#f7d7b0] dark:border-[#253630] shadow-2xl p-8 sm:p-14 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center text-left">
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <p className="text-sm text-[#4a5c55] dark:text-[#d3eee4] leading-relaxed">
              Leading Arav Innovations with an analytical approach to enterprise operations, Aryan Sayal directs diagnostic audit squads across India and the UAE to help companies convert operational insight into sustainable efficiency.
            </p>
            <div className="pt-2">
              <a
        ...
        <div className="max-w-5xl mx-auto rounded-[3rem] bg-gradient-to-br from-[#172420] via-[#101b17] to-[#1b2823] text-white p-10 sm:p-16 border-2 border-[#f15e1c] shadow-2xl space-y-8 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 pt-6 border-t border-[#253630] flex flex-wrap items-center justify-center gap-6 text-xs text-[#d3eee4]">
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4 text-[#2e936f]" /> Strict Confidentiality Guarantee
            </span>
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4 text-[#2e936f]" /> Measurable Operational ROI
            </span>
            <span className="flex items-center gap-1.5">
