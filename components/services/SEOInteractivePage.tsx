...
const pricingPlans = [
  {
    ...
    description: "Ideal for growing sites needing a technical SEO audit, Core Web Vitals report, and keyword intent map.",
    isPopular: false,
    features: [
      "Technical SEO & Crawlability Audit",
      "Sub-Second Core Web Vitals Benchmark",
      "High-Value Keyword Intent Mapping",
      "30-Minute Search Strategy Advisory",
      "Prioritized Technical Fix Roadmap",
    ],
  ...
  },
  {
    name: "Optimal Pack",
    price: "₹50,000",
    period: "monthly search retainer",
    description: "Full-funnel technical SEO, monthly topical content cluster creation, and authority building.",
    isPopular: true,
    features: [
      "Full On-Page & Technical SEO Optimization",
      "Monthly Content Pillar & Cluster Creation",
      "High-Authority Editorial Link Acquisition",
      "Local Google Business Profile Management",
      "Bi-weekly Ranking & Search Analytics Calls",
      "Dedicated Search Engine Pod",
    ],
  ...
  },
  {
    ...
    description: "Omnichannel enterprise SEO, dedicated search squad, AI keyword analytics, and multi-region support.",
    isPopular: false,
    features: [
      "Enterprise Multi-Region & E-Commerce SEO",
      "AI-Assisted Search Intent & Gap Analytics",
      "Dedicated Lead SEO Architect & Content Writer",
      "Quarterly CISO & Executive Search Reports",
      "100% White-Hat Policy Compliance Guarantee",
      "Unlimited Technical SEO Advisory",
    ],
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-12 border-b border-[#f7d7b0]/60 dark:border-[#253630]">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            ...
            <p className="text-sm sm:text-base text-[#4a5c55] dark:text-[#d3eee4]">
              Select from fixed-scope technical audits, monthly content cluster retainers, or enterprise search squads.
            </p>
          </div>
                ...
                <div className="space-y-4 text-left">
                  {plan.isPopular && (
                    <span className="px-3 py-1 rounded-full bg-[#fce3d3] text-[#f15e1c] text-[10px] font-mono font-bold uppercase tracking-wider inline-block">
                      Recommended For Organic Traffic Growth
                    </span>
                  )}
                  <div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-12 border-b border-[#f7d7b0]/60 dark:border-[#253630]">
        <div className="max-w-5xl mx-auto rounded-[2.5rem] bg-[#fefaf5] dark:bg-[#172420] border-2 border-[#f7d7b0] dark:border-[#253630] shadow-2xl p-8 sm:p-14 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center text-left">
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <p className="text-sm text-[#4a5c55] dark:text-[#d3eee4] leading-relaxed">
              Leading Arav Innovations with a data-driven approach to organic search, Aryan Sayal directs SEO strategy squads across India and the UAE to help brands build topical authority and turn search visibility into sustainable growth.
            </p>
            <div className="pt-2">
              <a
        ...
        <div className="max-w-5xl mx-auto rounded-[3rem] bg-gradient-to-br from-[#172420] via-[#101b17] to-[#1b2823] text-white p-10 sm:p-16 border-2 border-[#f15e1c] shadow-2xl space-y-8 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 pt-6 border-t border-[#253630] flex flex-wrap items-center justify-center gap-6 text-xs text-[#d3eee4]">
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4 text-[#2e936f]" /> 100% White-Hat Compliance
            </span>
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4 text-[#2e936f]" /> Transparent Real-Time Dashboards
            </span>
            <span className="flex items-center gap-1.5">
