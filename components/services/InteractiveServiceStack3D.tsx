...
const servicesData: ServiceItem[] = [
  ...
  },
  {
    ...
    description:
      "Cuts manual operational overhead by up to 60%; speeds up decision-making.",
  ...
  },
  {
    ...
    name: "Web & Custom Application Development",
  ...
  },
  {
    ...
    name: "Digital Marketing, SEO & AEO",
    shortName: "Marketing & AEO",
    description:
      "Generates high-intent lead pipelines and establishes search dominance.",
