  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative w-full rounded-[3rem] bg-white/95 dark:bg-[#172420]/95 backdrop-blur-md border border-[#f7d7b0] dark:border-[#253630] shadow-2xl p-8 sm:p-10 flex flex-col justify-between overflow-hidden transition-all duration-300 min-h-[600px] sm:min-h-[660px]"
      >
        ...
        <div className="relative z-20 flex items-center justify-between border-b border-[#f7d7b0]/60 dark:border-[#253630] pb-4 mb-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs sm:text-sm font-mono font-bold uppercase tracking-wider text-[#1b2823] dark:text-[#ffffff]">
        ...
        <div className="relative flex-1 min-h-[420px] sm:min-h-[460px] w-full my-2">
          <svg
          ...
          {/* Central Engine Node: DIGITAL CORE */}
          <div
            style={{ transform: "translate3d(-50%, -50%, 30px)" }}
            className="absolute top-1/2 left-1/2 z-20 flex flex-col items-center justify-center p-4 sm:p-5 rounded-3xl bg-white dark:bg-[#101b17] border-2 border-[#f15e1c] shadow-2xl shadow-[#f15e1c]/25 text-center min-w-[150px] sm:min-w-[170px] cursor-pointer hover:scale-105 transition-transform"
          >
            <div className="w-12 h-12 rounded-2xl bg-[#f15e1c] text-white flex items-center justify-center shadow-lg mb-1.5">
              <Layers className="w-6 h-6 animate-pulse" />
            </div>
            <span className="text-xs sm:text-sm font-mono font-extrabold text-[#1b2823] dark:text-[#ffffff] tracking-wider uppercase">
              DIGITAL CORE
            </span>
          ...
          {/* 3 Ecosystem Service Nodes: SPACED AT GENEROUS DISTANCE FROM CENTER */}
          {architectureNodes.map((node) => {
            const isActive = activeNode?.id === node.id;
            ...
            return (
              ...
              >
                <Link href={node.href} className="block">
                  <div
                    className={cn(
                      "p-3.5 sm:p-4 rounded-2xl bg-white dark:bg-[#101b17] border shadow-lg flex items-center gap-3 transition-all duration-300 group hover:shadow-2xl",
                      isActive
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="text-xs sm:text-sm font-bold font-display text-[#1b2823] dark:text-[#ffffff] group-hover:text-[#f15e1c] transition-colors flex items-center gap-1">
        ...
        {/* Bottom Line & Hover Banner: Positioned Completely Below Nodes */}
        <div className="relative z-30 pt-4 mt-4 border-t border-[#f7d7b0] dark:border-[#253630] flex items-center justify-between text-xs sm:text-sm min-h-[48px]">
          {activeNode ? (
