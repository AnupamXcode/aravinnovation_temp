...
export const servicesData: Service[] = [
  ...
  },
  {
    ...
    icon: "BarChart3",
    businessProblem: {
      title: "Operational Friction & Process Blind Spots",
      description:
        "As organizations evolve, operational handoffs, technology dependencies, and governance controls can accumulate unseen friction, duplication, and performance gaps.",
      painPoints: [
        "Unclear operational handoffs and manual workarounds across departments",
        "System reliability gaps and unmapped technical dependencies",
        "Inconsistent control effectiveness and evidence documentation",
        "Lack of objective, evidence-based prioritization for operational improvements",
      ],
    },
    ourSolution: {
      title: "Evidence-Based Diagnostics & Practical Improvement Roadmaps",
      description:
        "We combine independent process observation, technology analysis, and control reviews to turn raw evidence into clear, actionable priorities.",
      keyPillars: [
        {
          title: "Process & Operations Assessment",
          description: "Evaluating workflows, cycle times, handoffs, and resource utilization.",
        },
        {
          title: "Technology & Systems Review",
          description: "Analyzing infrastructure reliability, API integrations, and technical debt.",
        },
        {
          title: "Controls & Compliance Verification",
          description: "Reviewing operating procedures, RACI ownership, and evidence readiness.",
        },
      ],
    },
    capabilities: [
      {
        category: "Operational & Process Diagnostics",
        items: [
          "End-to-End Workflow & Handoff Inspection",
          "Process Friction & Cycle-Time Analysis",
          "Operational Bottleneck & Redundancy Mapping",
          "Resource Utilization & Efficiency Assessment",
        ],
      },
      {
        category: "Technology & Control Assurance",
        items: [
          "Systems Integration & Dependency Review",
          "Technical Debt & Infrastructure Reliability Scan",
          "Control Design & Implementation Testing",
          "Internal Audit Support & Evidence Readiness",
        ],
      },
    ],
    process: [
      {
        step: 1,
        title: "DEFINE",
        description: "Clarify objectives, scope, key stakeholders, and evaluation criteria.",
        deliverable: "Engagement Scope & Diagnostic Plan",
      },
      {
        step: 2,
        title: "UNDERSTAND",
        description: "Analyze workflows, system architectures, controls, and operational context.",
        deliverable: "Current-State Observation Map",
      },
      {
        step: 3,
        title: "ASSESS",
        description: "Review empirical evidence, run diagnostic checks, and test control effectiveness.",
        deliverable: "Evidence Repository & Gap Analysis",
      },
      {
        step: 4,
        title: "REPORT",
        description: "Synthesize findings, identify underlying root causes, and present opportunities.",
        deliverable: "Diagnostic Report & Root-Cause Matrix",
      },
      {
        step: 5,
        title: "PRIORITIZE",
        description: "Map findings by commercial impact and effort complexity into an actionable sequence.",
        deliverable: "Prioritized Improvement Roadmap",
      },
      {
        step: 6,
        title: "FOLLOW THROUGH",
        description: "Support agreed remediation actions and validate progress where requested.",
        deliverable: "Implementation Support & Progress Verification",
      },
    ],
    technologies: [
      {
        category: "Diagnostic Frameworks",
        stack: ["IIA Global Standards Alignment", "ISO 19011 Principles", "COSO Internal Control", "ITIL Service Management"],
      },
      {
        category: "Analytical & Assessment Tooling",
        stack: ["Workflow Telemetry", "Process Mapping Analysis", "System Reliability Scans", "Evidence Repositories"],
      },
    ],
    engagementModels: [
      {
        title: "Targeted Diagnostic Assessment",
        description: "A focused 2 to 3-week evaluation of a specific process, technology stack, or control framework.",
        bestFor: "Organizations seeking immediate clarity on known friction points or preparing for strategic changes.",
        ctaText: "Start an Assessment",
      },
      {
        title: "Comprehensive Operational Audit",
        description: "In-depth review of cross-functional workflows, system dependencies, and governance controls.",
        bestFor: "Enterprises needing an objective baseline across multiple operating divisions.",
    ...
    results: [
      {
        metric: "Clarity",
        label: "Current-State Visibility",
        context: "Empirical baseline of operational performance and process handoffs.",
      },
      {
        metric: "Priority",
        label: "Actionable Focus",
        context: "Clear separation of quick wins from long-term strategic improvements.",
      },
    ],
    faqs: [
      {
        question: "What does an Audit & Improvement engagement cover?",
        answer:
          "Engagements focus on evaluating operational workflows, technology dependencies, control effectiveness, and performance metrics. Scope is tailored to your specific organizational priorities.",
      },
      {
        question: "How is an operational assessment different from an internal audit?",
        answer:
          "An operational assessment evaluates efficiency, workflow friction, and practical improvements alongside control effectiveness. It provides actionable recommendations rather than purely formal compliance reporting.",
      },
      {
        question: "Can you assess technology and business processes together?",
        answer:
          "Yes. Modern business processes rely heavily on technology. We examine how software, systems, handoffs, and human workflows interact to identify root causes.",
      },
      {
        question: "How are audit findings prioritized?",
        answer:
          "Findings are categorized on a clean Priority Matrix based on commercial impact and implementation effort, ensuring teams focus first on high-value quick wins and strategic fixes.",
      },
      {
        question: "Can Arav support implementation after an assessment?",
        answer:
          "Yes. Where requested, our team supports agreed remediation actions, process redesign, and progress verification to ensure improvements take root.",
      },
    ],
