  ...
  return (
    <div className="pt-28 pb-20 bg-[#FFFDF9]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 rounded-3xl bg-[#FBF3EA] border border-[#EFE2D6] p-8 sm:p-12 text-center max-w-4xl mx-auto space-y-6">
          <div className="w-12 h-12 rounded-2xl bg-[#E8672A] text-white mx-auto flex items-center justify-center">
            <Globe2 className="w-6 h-6" />
          </div>
          <h3 className="text-2xl sm:text-3xl font-bold font-display text-[#3A2E27]">
            Need a Customized Multi-Practice Engagement?
          </h3>
          <p className="text-sm text-[#7A6A5F] max-w-xl mx-auto leading-relaxed">
