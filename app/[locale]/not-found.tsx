...
export default function NotFound() {
  return (
    <div className="min-h-[80vh] flex items-center justify-center pt-28 pb-20 bg-[#FFFDF9] dark:bg-[#12100E] px-4 sm:px-6 lg:px-8 transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#E8672A]/10 dark:bg-[#E8672A]/15 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-xl w-full text-center space-y-8 relative z-10">
        <div className="space-y-4">
          ...
          <div className="w-24 h-24 rounded-3xl bg-[#FCE3D3] dark:bg-[#261F1A] text-[#E8672A] mx-auto flex items-center justify-center font-display font-extrabold text-4xl border border-[#F4A97F]/40 dark:border-[#3D332B] shadow-lg animate-pulse">
            404
          </div>
        ...
        <div className="p-6 rounded-3xl bg-white dark:bg-[#171411] border border-[#EFE2D6] dark:border-[#2C241E] shadow-xl space-y-4 text-left">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              <div className="p-2 rounded-xl bg-[#E8672A]/10 text-[#E8672A]">
                <Home className="w-4 h-4" />
              </div>
              <div>
                <div className="font-bold group-hover:text-[#E8672A] transition-colors">Return Home</div>
            ...
            >
              ...
              <div>
                <div className="font-bold group-hover:text-[#E8672A] transition-colors">7 Core Practices</div>
            ...
            >
              ...
              <div>
                <div className="font-bold group-hover:text-[#E8672A] transition-colors">Case Studies</div>
            ...
            >
              ...
              <div>
                <div className="font-bold group-hover:text-[#E8672A] transition-colors">Contact Support</div>
