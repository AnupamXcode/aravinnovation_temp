...
const defaultChatbotCommands: ChatbotCommandItem[] = [
  ...
  },
  {
    ...
    ctaButtons: [
      ...
      { label: "Contact Compliance Pod", type: "email", value: "mailto:Info@aravinnovations.com" },
    ],
    priority: 9,
    enabled: true,
  },
  ...
  },
  {
    ...
    followUpResponse: "Would you like to schedule a direct consultation with our regional team in India or Dubai?",
    relatedPage: "/contact",
    ctaButtons: [
      { label: "Email Us", type: "email", value: "mailto:Info@aravinnovations.com" },
      { label: "WhatsApp Us", type: "whatsapp", value: "https://api.whatsapp.com/send?phone=971521555792&text=Hello%20Arav%20Innovations%2C%20I%27d%20like%20to%20discuss%20a%20project." },
      { label: "Email Us", type: "email", value: "mailto:Info@aravinnovations.com" },
    ],
    priority: 8,
